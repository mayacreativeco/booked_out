...
<div style="flex:1;display:flex;align-items:center;justify-content:center;padding:48px 24px;">
  <div style="max-width:520px;width:100%;text-align:center;">
    ...
    <div style="display:flex;gap:12px;justify-content:center;flex-wrap:wrap;margin-bottom:16px;">
      <div style="flex:1;min-width:180px;background:#EDE5D2;border:2px solid #1B3A2F;border-radius:4px;padding:20px;text-align:center;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#4A5C50;margin-bottom:6px;">monthly</div>
        <div style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:22px;font-weight:700;color:#1B3A2F;margin-bottom:12px;">$49<span style="font-size:13px;font-weight:400">/mo</span></div>
        <button onclick="(function(){var ms=window.$memberstackDom;if(!ms){alert('Loading — try again in a moment.');return;}ms.purchasePlansWithCheckout({planId:'pln_booked-out-kit-monthly-t7am03so'});})()" style="font-family:'JetBrains Mono',monospace;font-size:12px;font-weight:600;color:#F5F0E4;background:#1B3A2F;padding:10px 16px;border-radius:4px;border:none;cursor:pointer;width:100%;">&#8594; monthly plan</button>
      </div>
      <div style="flex:1;min-width:180px;background:#EDE5D2;border:2px solid #1B3A2F;border-radius:4px;padding:20px;text-align:center;">
        <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#4A7C59;margin-bottom:6px;">founding · locked in</div>
        <div style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:22px;font-weight:700;color:#1B3A2F;margin-bottom:12px;">$197<span style="font-size:13px;font-weight:400">/yr</span></div>
        <button onclick="(function(){var ms=window.$memberstackDom;if(!ms){alert('Loading — try again in a moment.');return;}ms.purchasePlansWithCheckout({planId:'pln_booked-out-kit-founding-annual-qrar03w5'});})()" style="font-family:'JetBrains Mono',monospace;font-size:12px;font-weight:600;color:#F5F0E4;background:#1B3A2F;padding:10px 16px;border-radius:4px;border:none;cursor:pointer;width:100%;">&#8594; founding price</button>
      </div>
    </div>
    <div style="background:#F5F0E4;border:1px solid #D8D0BE;border-radius:4px;padding:16px;text-align:center;margin-bottom:24px;">
      <div style="font-family:'JetBrains Mono',monospace;font-size:10px;color:#4A5C50;margin-bottom:4px;">annual</div>
      <div style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:16px;font-weight:700;color:#1B3A2F;margin-bottom:10px;">$397<span style="font-size:12px;font-weight:400">/yr</span> &nbsp;<span style="font-size:12px;font-weight:400;color:#4A5C50">· best value</span></div>
      <button onclick="(function(){var ms=window.$memberstackDom;if(!ms){alert('Loading — try again in a moment.');return;}ms.purchasePlansWithCheckout({planId:'pln_booked-out-kit-annual-1w3h0ueu'});})()" style="font-family:'JetBrains Mono',monospace;font-size:11px;color:#1B3A2F;background:transparent;border:1px solid #1B3A2F;padding:8px 20px;border-radius:4px;cursor:pointer;">annual plan</button>
    </div>
